                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <blockquote>
                            ...
                            <footer>注：<a href="${base}/app/iosApp.jsp">IOS请点击这里</a></footer>
                        </blockquote>
                        <form role="form" >
                          <!--   <button type="submit" ></button> -->
                            	<a class="btn btn-danger btn-block btn-lg" href="<sys:param key="APP_ANDROID_DOWNLOAD_URL"/>">Android点击下载</a>
                        </form>
                    </div>
                </div>
            </div>
