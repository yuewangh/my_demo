    ...
    <ul id="myTab" >
      <li onclick="top_mao('#Space')"> <a href="javascript:void(0)"   data-toggle="tab">
        <div class="col-md-6 col-sm-6 col-pading">
          <div class="grid mask">
            <figure> <img width="100%" class="img-responsive" src="${base}/resources/portal/images/r_1.jpg" alt="">
              <figcaption>
                <h2 >标准服务</h2>
              </figcaption>
            </figure>
      ...
      <li onclick="top_mao('#rengong')" > <a href="javascript:void(0)" data-toggle="tab">
        <div class="col-md-6 col-sm-6 col-pading">
          <div class="grid mask">
            <figure> <img width="100%"class="img-responsive" src="${base}/resources/portal/images/r_3.jpg" alt="">
              <figcaption>
                <h2>增值服务</h2>
              </figcaption>
            </figure>
...
/*
var $div_li = $("ul#myTab li");
		$div_li.click(function() {
		var index = $div_li.index(this);	
		var obj_top =$("div.tab-content > div").eq(index).offset().top;
		$("html,body").animate({scrollTop:obj_top},300);
...
/*$(function(){
       var navH = $(".top_servicefixed").offset().top;
        $(window).scroll(function(){
            var scroH = $(this).scrollTop();
            if(scroH>=navH){
                $(".top_servicefixed").addClass("fixed");
				
            }else if(scroH<navH){
				$(".top_servicefixed").removeClass("fixed");
            }
        })
