...
<div class="modal-header">
	<span style="font-weight:bold;font-size:18px;">已成交订单详情</span>
</div>
...
<div class="modal-footer">
	<button type="button" class="btn btn-default" data-dismiss="modal" onclick="window.location.href='${path}/order/lease/tolist.vhtml'">返回</button>
</div>
