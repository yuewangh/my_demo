...
<div class="modal-body">
    <form id="editUserForm" class="pagination_form form-horizontal" role="form" method="POST"
          action="${path}/system/account/saveUser.json">
	...
	<div class="form-group">
       ...
       <div class="form-group">
           ...
           <div class="col-sm-10">
           	<input type="text" id="name" name="name" value="${userInfoBean.name}" class="form-control input clearText"
           	 			data-rule-required="true"
							data-msg-required="请录入姓名。" data-rule-minlength="2"
       ...
       <div class="form-group">
           <label class="col-sm-2 control-label" for="dept">单位：</label>
           <div class="col-sm-10">
           	<input type="text" id="dept" name="dept" value="${userInfoBean.dept}" class="form-control input clearText"
           	 						maxlength="50"
									placeholder="所在单位"
									data-msg-required="请录入所在单位" 
									 style="width:210px;" />
           </div>
       </div>
       <div class="form-group">
           <label class="col-sm-2 control-label" for="job">职位：</label>
           <div class="col-sm-10">
               <input type="text" id="job" name="job" value="${userInfoBean.job}" class="form-control input clearText"
