package com.isoftstone.demo.platformservice.web.controller;
...
@RequestMapping("/portal/pfService")
@Controller
public class PortalPlatformServiceController {
	@Autowired
	...
	public ModelAndView index(@RequestParam(value="page",defaultValue="1")String pageStr,
		...
		params.put("portletId","pfService");
		int page = 1;
		try{
		...
		return new ModelAndView("/portal/service/index.jsp");
	}
}
